...
// WiFi access point
#define WIFI_AP_NAME        "Rukita_Lotus"
// WiFi password
#define WIFI_PASSWORD       "hasslefree66"

// See https://thingsboard.io/docs/getting-started-guides/helloworld/ 
// to understand how to obtain an access token
#define TOKEN               "SuksesUAS"
// ThingsBoard server instance.
#define THINGSBOARD_SERVER  "192.168.101.155"
